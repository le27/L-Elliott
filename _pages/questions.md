...
([source](https://arxiv.org/pdf/1912.07029)) Are the two minimal Polish semigroup topologies and the unique maximal Polish semigroup topology on $I_{\mathbb{N}}$ the only three Polish semigroup topologies on $I_{\mathbb{N}}$?

Answer: No. This was first shown [here](https://arxiv.org/pdf/2405.20134). The paper classifies all Polish semigroup topologies on $I_{\mathbb{N}}$. There are countably infinitely many.

([source](https://arxiv.org/pdf/1912.07029)) Is the semigroup version of the Zariski topology applied to a group equal to the group
